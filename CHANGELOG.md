...
- Improved hover: variable/function signature is shown as a syntax-highlighted `period` code block on the first line, and variables defined inside blocks (e.g. inside `while`) also show hover.
